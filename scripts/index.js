...
$(function () {
    ...
    var graph2 = function(){
      ...
      Morris.Donut({
        ...
        hideHover: 'auto',
        colors: ["#73DCFF", "#008C69","#00468C", "#59B300"]
    ...
    var chart1 = function(){
      ...
      Morris.Bar({
        ...
        barColors: [ "#4CA6FF","#006CD9", "#FF7373"]
      });
    ...
    $("#pie-chart4").sparkline([70,110, 130, 90], {
      type: 'pie',
      height: 300,
      sliceColors: ['#00B386','#99B2FF','#304000','#C0CA55','#384b5e','#999999']
    });
